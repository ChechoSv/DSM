...
public class Ejercicio3Resultado extends AppCompatActivity {
   Double h1,h2,h3;
            ...
            case "gerente":
                if (h1 <= 160) {
                   ...
                   bono1=sT1*0.1;
                    ...
                    Toast toast1 = Toast.makeText(getApplicationContext(),"El empleado " + n1 + " Cargo: " + c1 +" Sueldo total " + T1,Toast.LENGTH_SHORT);
                    toast1.show();
